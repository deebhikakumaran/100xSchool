...
export async function createTravelPlan(
  ...
  budget: number
    ...
    const query = `INSERT INTO travel_plans (user_id, title, destination_city, destination_country, start_date, end_date, budget)
                   VALUES ($1, $2, $3, $4, $5, $6, $7)
                   RETURNING title, destination_city, destination_country, start_date, end_date, budget, id`
    const values = [userId, title, destinationCity, destinationCountry,
